...
class UpdateGameRatingUseCaseTest extends TestCase
{
    ...
    public function throws_when_user_not_found(): void
    {
        ...
        $command = new UpdateGameRatingCommand(userId: 999, gameId: 12345, rating: Rating::fromFloat(4.0));
    ...
    public function throws_when_game_not_in_library(): void
    {
        ...
        $command = new UpdateGameRatingCommand(userId: 1, gameId: 12345, rating: Rating::fromFloat(4.0));
    ...
    public function successfully_updates_rating(): void
    {
        ...
        $this->userGameRepo->expects($this->once())->method('updateRating')
            ->with(1, 12345, 4.0);
